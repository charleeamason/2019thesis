...
Same as v170813 but in different format.

29 = NlogTeff, number of effective temperatures
...
Column 4: logTeff(K) = 5.10,5.15,5.20,...,6.50
Column 5: logg(cm s^-2) = 13.7,13.8,...,14.7

3547918 rows = 29*11*166*67 = NlogTeff*Nlogg*NlogEkT*Nmu
Order of table:
